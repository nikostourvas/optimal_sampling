...
```{r DE_Ho_He, fig.height=4, fig.width=10, cache=T}
...
```{r DE_Ar_perc, fig.height=4, fig.width=10, cache=T}
...
```{r}
load("/home/rstudio/working/Dropbox/WORK/LIFEGenMon/optimal_sampling/Simulations_adegenet/Optimal_Sampling_simulation_data/Abies_distances/Abies_DE_Adult_100_repl_differentiation_results.RData")
```

```{r DE_fst_dch, fig.height=4, fig.width=10, cache=T}
fst_tidy3 <- fst_tidy %>% 
  filter(marker_num %in% c('5 markers', '8 markers', '11 markers'))
